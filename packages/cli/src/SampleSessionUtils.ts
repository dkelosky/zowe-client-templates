import { ICommandOptionDefinition, ICommandArguments, Logger, ISession } from "@zowe/imperative";
...
export class SampleSessionUtils {
    ...
    public static SAMPLE_OPTION_USER: ICommandOptionDefinition = {
        ...
        aliases: ["u"],
        type: "string",
        description: "User name for authenticating connections to the Sample API service that is running.",
        required: false,
        group: SampleSessionUtils.SAMPLE_CONNECTION_OPTION_GROUP
    };
    ...
    public static SAMPLE_OPTION_PASSWORD: ICommandOptionDefinition = {
        ...
        aliases: ["pass", "pw"],
        type: "string",
        description: "Password for authenticating connections to the Sample API service that is running.",
        required: false,
        group: SampleSessionUtils.SAMPLE_CONNECTION_OPTION_GROUP
    };
    ...
    public static SAMPLE_OPTION_PROTOCOL: ICommandOptionDefinition = {
        name: "protocol",
        aliases: ["o"],
        description: "Specifies protocol to use for Sample connection (http or https).",
        type: "string",
        defaultValue: "https",
        required: false,
